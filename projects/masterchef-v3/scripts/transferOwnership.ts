...
const abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: true,
        internalType: "contract IMonPool.sol.sol",
        name: "v3Pool",
        type: "address",
      },
      {
...
async function main() {
  ...
  const mcV3Contract = new Contract("0x27968E2A94aD65F36E1788b623CFAD82f86bD459", abi, owner);
  try {
    await mcV3Contract.transferOwnership("0x31fB83Dc60D27C9C4a58a361bc9c48e0Bcfe902B");
  } catch (error) {
    console.error(error);
  }
}
