...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function transfer(address _to, uint _value) virtual override public onlyPayloadSize(2 * 32) {
    ...
    function balanceOf(address _owner) override view virtual public returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function transferFrom(address _from, address _to, uint _value) virtual  public override onlyPayloadSize(3 * 32) {
    ...
    */
    function approve(address _spender, uint _value) virtual  public override onlyPayloadSize(2 * 32) {
    ...
    function allowance(address _owner, address _spender)  virtual view public override returns (uint remaining) {
...
contract TetherTokenV2 is Pausable, StandardToken, BlackList {
    string public name;
