...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    ...
    function balanceOf(address _owner) override virtual public returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    ...
    function allowance(address _owner, address _spender)  virtual  public override returns (uint remaining) {
...
contract T10Token is Pausable, StandardToken, BlackList {
    string public name;
