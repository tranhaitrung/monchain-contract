...
} from '@pancakeswap/v3-core/artifacts/contracts/MonFactory.sol.sol/MonFactory.sol.json'
import {
  abi as DEPLOYER_ABI,
  bytecode as DEPLOYER_BYTECODE,
} from '@pancakeswap/v3-core/artifacts/contracts/MonPoolDeployer.sol.sol/MonPoolDeployer.sol.json'
