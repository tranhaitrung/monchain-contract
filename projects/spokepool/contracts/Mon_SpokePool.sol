...
/**
 * @notice Mon L1 specific SpokePool. Used on Mon L1 to facilitate L2->L1 transfers.
 * @custom:security-contact bugs@across.to
 */
contract Mon_SpokePool is SpokePool, OwnableUpgradeable {
    ...
    /**
     * @notice Construct the Mon SpokePool.
    ...
    // A core assumption of this contract system is that the HubPool is deployed on Mon.
